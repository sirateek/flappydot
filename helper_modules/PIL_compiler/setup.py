    ...
    def build_extensions(self):
        ...
        if self.disable_platform_guessing:
            ...
            _add_directory(
                library_dirs,
                os.path.join(
                    "/usr/lib", "python{}.{}".format(*
                                                     sys.version_info), "config"
                ),
            )
            ...
            if ft_prefix and os.path.isdir(ft_prefix):
                ...
                _add_directory(include_dirs, os.path.join(
                    ft_prefix, "include"))
            else:
